...
class CubeFlatShadingIndependentScene : public Scene
{
public:
	typedef Pipeline<VertexFlatEffect> Pipeline;
	typedef Pipeline::Vertex Vertex;
public:
	CubeFlatShadingIndependentScene(Graphics& gfx)
		:
		itlist(Cube::GetIndependentFaceNormals<Vertex>()),
		pipeline(gfx),
		Scene("Cube flat vertex shading scene")
	{}
	...
	virtual void Draw() override
	{
		...
		pipeline.effect.vs.SetLightDirection(rot_phi * light_dir);
		// render triangles
