...
public:
	...
	{
		itlist.vertices[0].color = Vec3(Colors::Black);
		itlist.vertices[1].color = Vec3(Colors::Blue);
		itlist.vertices[2].color = Vec3(Colors::Cyan);
		itlist.vertices[3].color = Vec3(Colors::Green);
		itlist.vertices[4].color = Vec3(Colors::Red);
		itlist.vertices[5].color = Vec3(Colors::White);
		itlist.vertices[6].color = Vec3(Colors::Yellow);
		itlist.vertices[7].color = Vec3(Colors::Gray);
	}
